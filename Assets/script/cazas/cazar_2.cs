...
public class cazar_2 : MonoBehaviour
{
    ...
    public void OnTriggerEnter(Collider col)
    {
        ...
        {
            SceneManager.LoadScene("madcatev3");
        }
        if (col.gameObject.tag == "shitfloor")
        {
            SceneManager.LoadScene("shitfloorev3");
        }
        if (col.gameObject.tag == "topo")
        {
            SceneManager.LoadScene("topoev3");
        }
        if (col.gameObject.tag == "skybird")
        {
            SceneManager.LoadScene("skybirdev3");
        }
    }
}

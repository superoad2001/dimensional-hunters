...
public class madcatev2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (comienzo == true)
        {
            ...
            if (frases == 3 && temp > 3 && comienzo == true)
            {   
                ...
                PlayerPrefs.SetFloat("hpr", Random.Range(160f,170));
                PlayerPrefs.SetFloat("manar", Random.Range(95f,105));
                PlayerPrefs.SetFloat("manarecr", Random.Range(0.75f,0.85f));
                PlayerPrefs.SetFloat("fuerzar", Random.Range(1.05f,1.15f));
                PlayerPrefs.SetString("tipor", "terreno");
                PlayerPrefs.SetFloat("nivelr", 6);
                PlayerPrefs.SetString("razar", "happycat");
        ...
        if (comienzo == false && frases == 3 && temp4 > 3)
        {

...
public class madcatev3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (comienzo == true)
        {
            ...
            {   
                if(decision == 0)
                {
                    ...
                    if(decision == 4 )
                    {
                       audio = audio4;audio.Play();
                    }
                    if(decision == 5 )
                    {
                       audio = audio5;audio.Play();
                    }
                    if(decision == 6 )
                    {
                       audio = audio6;audio.Play();
                    }
                    barra.text = "escucha";
                    temp1 = 3;
                ...
                if(decision == 4 && !audio.isPlaying)
                {
                    if(frased4 == true)
                    {frases =1; decision = 0;temp = 0;}
                }
                if(decision == 5 && !audio.isPlaying)
                {
                    if(frased5 == true)
                    {frases =1; decision = 0;temp = 0;}
                }
                if(decision == 6 && !audio.isPlaying)
                {
                    if(frased6 == true)
                    {frases =1; decision = 0;temp = 0;}
                }
            ...
            {   
                if(decision == 0)
                {
                    decision = Random.Range(1,7);
                    frase3 = decision;
                    if(decision == frase1 ||decision == frase2)
                    {decision = 0;}
                    if(decision == 1 )
                    {
                       audio = audio1;audio.Play();
            ...
            {   
                if(decision == 0)
                {
                    decision = Random.Range(1,7);
                    frase4 = decision;
                    if(decision == frase1 ||decision == frase2  ||decision == frase3)
                    {decision = 0;}
                    if(decision == 1 )
                    {
                       audio = audio1;audio.Play();
            ...
            {   
                if(decision == 0)
                {
                    decision = Random.Range(1,7);
                    frase5 = decision;
                    if(decision == frase1 ||decision == frase2  ||decision == frase3 ||decision == frase4)
                    {decision = 0;}
                    if(decision == 1 )
                    {
                       audio = audio1;audio.Play();
            ...
            if (frases == 5 && temp > 3 && comienzo == true)
            {   
                ...
                PlayerPrefs.SetFloat("hpr", Random.Range(215f,125));
                PlayerPrefs.SetFloat("manar", Random.Range(180f,195));
                PlayerPrefs.SetFloat("manarecr", Random.Range(1.10f,1.15f));
                PlayerPrefs.SetFloat("fuerzar", Random.Range(1.40f,1.45f));
                PlayerPrefs.SetString("tipor", "terreno");
                PlayerPrefs.SetFloat("nivelr", 11);
                PlayerPrefs.SetString("razar", "crazycat");
        ...
        if (comienzo == false && frases == 5 && temp4 > 3)
        {
